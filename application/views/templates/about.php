<div id='about-page'>
	<section class='details'>
		<img src='<?php echo siteUrl('images/trevor_geene.jpg'); ?>' alt='Trevor Geene' class='profile-picture'
			 width='250px'/>
	...
	<section class='history'>
		...
		<p>I have over 10 years of experience building clients websites and applications using a variety of
			...
			recipe manager, many ecommerce stores, and much more.</p>
	</section>
	<section class='languages'>
		<h3>Language / System Specializations</h3>
		<dl>
			<dt>Frontend Languages &amp; Frameworks</dt>
			<dd>
				<ul class='skills'>
					<li>HTML 5</li>
			...
			<dt>Servers &amp; Virtual Environments</dt>
			<dd>
				<ul class='skills'>
					<li>CentOS</li>
					<li>Ubuntu</li>
			...
			<dt>Server &amp; File Management Systems</dt>
			<dd>
				<ul class='skills'>
					<li>WHM/CPanel</li>
					<li>FTP</li>
